...
namespace com.ootii.Actors.AnimationControllers
{
    ...
    public class WalkRunRotate_v2 : MotionControllerMotion, IWalkRunMotion
    {
        ...
        public override bool TestActivate()
        {
            ...
            if (mMotionController.Stance != EnumControllerStance.TRAVERSAL) { return false; }
        ...
        public override void UpdateRootMotion(float rDeltaTime, int rUpdateIndex, ref Vector3 rMovement, ref Quaternion rRotation)
        {
            ...
            if (lMovementSpeed > 0f)
            {
                ...
                {
                    float lInputX = (mMotionController._InputSource != null && mMotionController._InputSource.IsPressed(_StrafeLeftActionAlias) ? -1f : 0f);
                    lInputX = lInputX + (mMotionController._InputSource != null && mMotionController._InputSource.IsPressed(_StrafeRightActionAlias) ? 1f : 0f);

                    float lInputY = mMotionController.State.InputY;

                    Vector3 lDirection = new Vector3(lInputX, 0f, lInputY);
        ...
        public override void Update(float rDeltaTime, int rUpdateIndex)
        {
            ...
            if (mMotionController._InputSource != null && mMotionController._InputSource.IsPressed(_RotateActionAlias))
            {
