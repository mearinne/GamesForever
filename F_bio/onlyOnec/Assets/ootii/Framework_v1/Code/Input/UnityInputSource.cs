    ...
    public class UnityInputSource : MonoBehaviour, IInputSource
    {
        ...
        public virtual float MovementX
        {
            get
            {
               ...
               // if (UnityEngine.Input.GetKey(KeyCode.D) || UnityEngine.Input.GetKey(KeyCode.RightArrow)) { lValue++; }
                if (UnityEngine.Input.GetKey(KeyCode.D) || MyMovement.controlVal > 0) { lValue++; }
               // if (UnityEngine.Input.GetKey(KeyCode.A) || UnityEngine.Input.GetKey(KeyCode.LeftArrow)) { lValue--; }
                if (UnityEngine.Input.GetKey(KeyCode.A) || MyMovement.controlVal < 0) { lValue--; }
        ...
        public virtual float MovementY
        {
            get
            {
                ...
                //if (UnityEngine.Input.GetKey(KeyCode.W) || MyMovement.controlVal>0) { lValue++; }
                if (UnityEngine.Input.GetKey(KeyCode.S) || UnityEngine.Input.GetKey(KeyCode.DownArrow)) { lValue--; }
                //if (UnityEngine.Input.GetKey(KeyCode.S) || MyMovement.controlVal< 0) { lValue--; } 
